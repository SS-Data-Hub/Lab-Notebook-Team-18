...
\noindent\makebox[0.4\textwidth]{\hrulefill} \hfill \makebox[0.5\textwidth]{\hrulefill}

\noindent\makebox[0.4\textwidth]{Candidate's Signature} \hfill \makebox[0.5\textwidth]{Registration Number}
\newpage
